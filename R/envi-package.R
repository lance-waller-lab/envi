...
#'
#' @details For a single species with presence and absence data, the 'envi' package uses the spatial relative risk function estimated using the \code{\link[sparr]{sparr-package}} package. Details about the \code{\link[sparr]{sparr-package}} package methods can be found in the tutorial: Davies et al. (2018) \doi{10.1002/sim.7577}. Details about kernel density estimation can be found in J. F. Bithell (1990) \doi{10.1002/sim.4780090616}. More information about relative risk functions using kernel density estimation (KDE) can be found in J. F. Bithell (1991) \doi{10.1002/sim.4780101112}.
#' 
...
#' 
#' @section Dependencies: The 'envi' package relies heavily upon \code{\link[sparr]{sparr-package}}, \code{\link[spatstat.geom]{spatstat.geom-package}}, \code{\link[sf]{sf-package}}, and \code{\link[terra]{terra-package}}. For a single species (presence/absence data), the spatial relative risk function uses the \code{\link[sparr]{risk}} function. Cross-validation is can be performed in parallel using the \code{\link[future]{multisession}}, \code{\link[doFuture]{doFuture-package}}, \code{\link[doRNG]{doRNG-package}}, and \code{\link[foreach]{foreach-package}} functions. Spatial perturbation is performed using the \code{\link[spatstat.geom]{rjitter}} function. Basic visualizations rely on the \code{\link[spatstat.geom]{plot.ppp}} and \code{\link[fields]{image.plot}} functions.
#' 
