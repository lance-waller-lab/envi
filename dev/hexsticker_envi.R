...
# Recently modified on: September 10, 2020
#
# Notes:
...
# Packages
loadedPackages <- c("hexSticker", "sp", "spatstat", "maptools")
...
s <- hexSticker::sticker(subplot = ~ plot.ppp(test, pch = "♥", cols = c("#FFFFFF", "#000000"), main = "", legend = FALSE, border = "#c8ec96", cex = 0.1),
