...
```{r packages}
loadedPackages <- c("envi", "maptools", "raster", "RStoolbox", "spatstat.data", "spatstat.geom", "spatstat.random")
...
pc1 <- pca_bands[[1]] # PC1
pc2 <- pca_bands[[2]] # PC2
pc1 <- spatstat.geom::as.im(pc1) # convert to class 'im'
pc2 <- spatstat.geom::as.im(pc2) # convert to class 'im'
